...
--Data Stansardization & Consistency
...
select distinct prd_line from silver.crm_prd_info
 ...
 --where start date is higher than end date, fix it on an excel
...
--check for validity of bdate (checking for old customers or bdate in the future)
-- Identify Out-of-Range Dates (alternatively written)
